...
#else
        return comm->c_coll->coll_barrier(comm, comm->c_coll->coll_bcast_module, &item);
#endif
    }
...
#else
    low_comm->c_coll->coll_barrier(low_comm,low_comm->c_coll->coll_barrier_module, &item);
#endif
...
#else
        up_comm->c_coll->coll_barrier(up_comm, up_comm->c_coll->coll_barrier_module, &item);
#endif
    }
