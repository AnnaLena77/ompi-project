...
/*Kombiniert die Daten, die zum Target-Prozess transportiert werden sollen mit denen, 
die bereits vorhanden sind. Vergleich zu MPI-Put: Daten werden dort vollstaendig ueberschrieben.*/
                   ...
                   MPI_Datatype target_datatype, MPI_Op op, MPI_Win win)
{
    ...
    initQentry(&item, target_rank, "MPI_Accumulate", 14, origin_count, 0, "one-sided", 9, origin_datatype, NULL, NULL, 0, op);
    #endif
