...
//Daten in Window des Target-Prozesses speichern
            ...
            MPI_Datatype target_datatype, MPI_Win win)
{
    ...
    initQentry(&item, target_rank, "MPI_Put", 7, origin_count, target_count, "one-sided", 9, origin_datatype, target_datatype, NULL, 0, NULL);
#endif
