...
static char *getTimeString(struct timespec time){
    ...
    snprintf(timestamp, sizeof(timestamp), "'%d-%02i-%02i %02i:%02i:%02i.%06li'", local_time.tm_year + 1900, local_time.tm_mon + 1, local_time.tm_mday, local_time.tm_hour, local_time.tm_min, local_time.tm_sec, nanoseconds);
